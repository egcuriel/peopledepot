...
def test_user_practice_area_relationship(user, user2):
    ...
    assert project_management_practice_area.practice_areas_secondary.contains(user2)
    ...
    assert not project_management_practice_area.practice_areas_secondary.contains(user2)
